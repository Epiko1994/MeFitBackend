...
insert into exercises (set_id, name, description, target_muscle_group, image, video_link) values (5,'Jumping jacks', 'Stand feet together, arms by your side. Jump your feet to the sides, wider than hip distance while bring your straight arms to meet above your head.', 'Full body', 'https://image.shutterstock.com/image-vector/jumping-jacks-exercise-girl-workout-600w-1633713496.jpg', 'https://www.youtube.com/watch?v=iSSAk4XCsRA');
...
insert into exercises (set_id, name, description, target_muscle_group, image, video_link) values (1,'Lunges', 'Start standing upright hands on hips. Step forward with one foot.Back knee touches ground below hip', 'Lower body', 'https://thumbs.dreamstime.com/z/man-doing-dumbbell-walking-lunges-exercise-man-doing-dumbbell-walking-lunges-exercise-flat-vector-illustration-isolated-white-230812187.jpg', 'https://www.youtube.com/watch?v=QOVaHwm-Q6U');
insert into exercises (set_id, name, description, target_muscle_group, image, video_link) values (2,'Hip raises', 'Start lying on your back, knees bend, feet on the floor. Lift hips off the floor until fully extended shouldblades lifted off the floor. Slowly lower back down', 'Lower body', 'https://image.shutterstock.com/z/stock-photo-hip-raises-360740402.jpg', 'https://www.youtube.com/watch?v=fDP6O_aJpDg');
