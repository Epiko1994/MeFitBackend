...
insert into exercises (name, description, target_muscle_group, image, video_link) values ('Squat', 'at turpis a pede posuere nonummy integer non velit donec diam neque vestibulum eget vulputate ut ultrices vel', 'Lower body', 'https://thumbs.dreamstime.com/z/squat-sport-exersice-silhouettes-woman-doing-exercise-workout-training-squat-sport-exersice-silhouettes-woman-doing-exercise-119786597.jpg', 'http://dummyimage.com/170x100.png/cc0000/ffffff');
insert into exercises (name, description, target_muscle_group, image, video_link) values ('Jump squat', 'at turpis a pede posuere nonummy integer non velit donec diam neque vestibulum eget vulputate ut ultrices vel', 'Lower body', 'http://dummyimage.com/178x100.png/dddddd/000000', 'http://dummyimage.com/170x100.png/cc0000/ffffff');
insert into exercises (name, description, target_muscle_group, image, video_link) values ('Lunges', 'at turpis a pede posuere nonummy integer non velit donec diam neque vestibulum eget vulputate ut ultrices vel', 'Lower body', 'http://dummyimage.com/178x100.png/dddddd/000000', 'http://dummyimage.com/170x100.png/cc0000/ffffff');
insert into exercises (name, description, target_muscle_group, image, video_link) values ('Hip raises', 'at turpis a pede posuere nonummy integer non velit donec diam neque vestibulum eget vulputate ut ultrices vel', 'Lower body', 'http://dummyimage.com/178x100.png/dddddd/000000', 'http://dummyimage.com/170x100.png/cc0000/ffffff');
